...
const Tooltip: React.FC<PropsWithChildren<TooltipProps>> = ({
  ...
  return (
    <div className="relative cursor-pointer">
      ...
      >
        <div className="bg-opacity-50 rounded-sm bg-zinc-500/50 px-2 py-1">
      ...
      <div
        className={twJoin(
          ...
          place === "bottom"
            ? "top-full translate-y-[2px] border-t-0 border-b-[6px] border-b-zinc-500/50"
            : "bottom-full -translate-y-[2px] border-t-[6px] border-b-0 border-t-zinc-500/50",
        )}
      ></div>
    </div>
  )
